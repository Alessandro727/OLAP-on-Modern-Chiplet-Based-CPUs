...
for x in values[1:]:
    ...
    SingleStore.append(noiW_m_gmean)
...
plt.plot(size, SingleStore, 'X-', color='fuchsia', markersize=10, label='SingleStore')
...
plt.savefig('Singlestore_number_of_instances_speedup.pdf',bbox_inches='tight',dpi=6000,backend='pgf')
