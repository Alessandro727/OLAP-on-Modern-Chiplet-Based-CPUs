...
for s in [1,max_cores]:
    ...
    Presto_results.append(total_time)
...
Presto_WIM_FT = Presto_results[0]/Presto_results[1]

Presto_WIN_MEM = Presto_results[0]/Presto_results[2]


plt.bar([0.2,1.0],[Presto_WIM_FT,Presto_WIN_MEM],width=0.2, color = 'LightSkyBlue', edgecolor = 'blue', label='Presto', fill=True, hatch='///')
...
plt.savefig('Presto_multicore_speedup_barplot.pdf',bbox_inches='tight',dpi=6000,backend='pgf')
