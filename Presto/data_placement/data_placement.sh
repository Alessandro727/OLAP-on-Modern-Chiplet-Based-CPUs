...
do
	...
	echo ""
	cd ../
	./Presto_benchmark.sh -t -s 100 -m WIM -p $i -d data_placement/WIM_${i}/
	cd data_placement/
done
...
do
        ...
        echo ""
        cd ../
        ./Presto_benchmark.sh -t -s 100 -m WIN -p $i -d data_placement/WIN_${i}/
        cd data_placement/
done
...
do
        ...
        echo ""
        cd ../
        ./Presto_benchmark.sh -t -s 100 -m WIC -p $i -d data_placement/WIC_${i}/
        cd data_placement/
done
