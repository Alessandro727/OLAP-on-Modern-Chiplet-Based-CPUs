...
Presto = [wim_int_gmean, win_ft_gmean, win_int_gmean, win_mem_gmean, wic_ft_gmean, wic_int_gmean, wic_mem_gmean]


plt.figure(figsize=(3.5,2))


pop=plt.bar([0,0.4,0.8,1.2,1.6,2,2.4], Presto, width=0.2, color = 'LightSkyBlue', edgecolor = 'blue', label='Presto', fill=True, hatch='///')
...
plt.savefig('Presto_data_placement.pdf',bbox_inches='tight',dpi=6000,backend='pgf')
