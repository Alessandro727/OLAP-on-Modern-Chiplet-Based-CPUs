...
plt.plot([1,2,3,4,5,6,7], Greenplum, 's-', color='Lime', markersize=10, label= 'Greenplum')
...
plt.savefig('Greenplum_number_of_instances_speedup.pdf',bbox_inches='tight',dpi=6000,backend='pgf')
