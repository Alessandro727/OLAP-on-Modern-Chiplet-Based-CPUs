...
\COPY part FROM './benchmark-greenplum/dbgen//part.tbl' WITH csv DELIMITER '|';
\COPY region FROM './benchmark-greenplum/dbgen//region.tbl' WITH csv DELIMITER '|';
\COPY nation FROM './benchmark-greenplum/dbgen//nation.tbl' WITH csv DELIMITER '|';
\COPY supplier FROM './benchmark-greenplum/dbgen//supplier.tbl' WITH csv DELIMITER '|';
\COPY customer FROM './benchmark-greenplum/dbgen//customer.tbl' WITH csv DELIMITER '|';
\COPY partsupp FROM './benchmark-greenplum/dbgen//partsupp.tbl' WITH csv DELIMITER '|';
\COPY orders FROM './benchmark-greenplum/dbgen//orders.tbl' WITH csv DELIMITER '|';
\COPY lineitem FROM './benchmark-greenplum/dbgen//lineitem.tbl' WITH csv DELIMITER '|';
